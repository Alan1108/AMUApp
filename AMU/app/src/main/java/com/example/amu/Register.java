...
public class Register extends AppCompatActivity {
    ...
    public void onClickRegister(View view){
        ...
        EditText enterprise = findViewById(R.id.txtEmpresa);
        ...
        if(name.getText().toString().equals("")){
            ...
            mostrarDialogo("Ningun campo debe estar vacio!");
            bandera=false;
        }else if(enterprise.getText().toString().equals("")){
            mostrarDialogo("Ningun campo debe estar vacio!");
            bandera=false;
        ...
        long id = dbUsersController.insertUser(new Person(name.getText().toString(),lastName.getText().toString(),
                email.getText().toString(),user.getText().toString(),password1.getText().toString(),enterprise.getText().toString()));
        if(bandera && id>0){
